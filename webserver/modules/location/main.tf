...
// as this storage account will be part of a module, we need to parameterise its name
// hence we will use "random_string" provider to randomise the name of the account
